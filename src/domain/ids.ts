...
export const DeliveryId = Schema.String.pipe(Schema.brand("@Gateway/DeliveryId"));
export type DeliveryId = Schema.Schema.Type<typeof DeliveryId>;

export const OrganizationId = Schema.String.pipe(Schema.brand("@Gateway/OrganizationId"));
...
export const ActivityId = Schema.String.pipe(Schema.brand("@Gateway/ActivityId"));
...
export const WorkspaceId = Schema.String.pipe(Schema.brand("@Gateway/WorkspaceId"));
