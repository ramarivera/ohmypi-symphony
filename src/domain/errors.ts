...
export class RowDecodeError extends Schema.TaggedError<RowDecodeError>()(
...
export class LinearRateLimitError extends Schema.TaggedError<LinearRateLimitError>()(
  "@Gateway/LinearRateLimitError",
  { ...message, retryAfterMs: Schema.optional(Schema.Number) },
) {}
export class TokenRefreshError extends Schema.TaggedError<TokenRefreshError>()(
  "@Gateway/TokenRefreshError",
  { ...message, organizationId: Schema.String },
) {}
export class WebhookSignatureError extends Schema.TaggedError<WebhookSignatureError>()(
  "@Gateway/WebhookSignatureError",
  message,
) {}
export class WebhookReplayError extends Schema.TaggedError<WebhookReplayError>()(
  "@Gateway/WebhookReplayError",
  { ...message, timestamp: Schema.Number },
) {}
export class WebhookPayloadError extends Schema.TaggedError<WebhookPayloadError>()(
  "@Gateway/WebhookPayloadError",
  { ...message, status: Schema.Number },
) {}
export class WebhookIdentityError extends Schema.TaggedError<WebhookIdentityError>()(
...
export class RunLeaseError extends Schema.TaggedError<RunLeaseError>()(
  "@Gateway/RunLeaseError",
  { ...message, sessionId: Schema.String },
) {}
export class RpcSpawnError extends Schema.TaggedError<RpcSpawnError>()(
  "@Gateway/RpcSpawnError",
  message,
) {}
export class RpcProtocolError extends Schema.TaggedError<RpcProtocolError>()(
  "@Gateway/RpcProtocolError",
  { ...message, method: Schema.String },
) {}
export class RpcTimeoutError extends Schema.TaggedError<RpcTimeoutError>()(
  "@Gateway/RpcTimeoutError",
  { ...message, method: Schema.String },
) {}
export class WorkspaceError extends Schema.TaggedError<WorkspaceError>()(
  "@Gateway/WorkspaceError",
  {
    ...message,
