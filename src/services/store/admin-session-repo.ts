...
import { SqliteClient, tryDb, decodeRow } from "./sqlite-client.js";
    ...
    effect: Effect.gen(function* () {
      ...
      const get = Effect.fn("AdminSessionRepo.get")(
        function* (
          ...
          Option.Option<{ readonly organizationId: OrganizationId; readonly csrfTokenHash: string }>,
      ...
      const deleteAdminSession = Effect.fn("AdminSessionRepo.deleteAdminSession")(
        function* (tokenHash: string): Effect.Effect<boolean, DatabaseError> {
          yield* Effect.annotateCurrentSpan("tokenHash", tokenHash);
